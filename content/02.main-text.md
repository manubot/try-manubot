...
Quick test to see how editing fork in github goes.
Additional test by the same user, this time using github desktop to manage GitHub interactions instead of directly on the web.
